...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/abdelkader-boukert-517495302/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@bd_.01",
    icon: Instagram,
    url: "https://www.instagram.com/bd_.01/?hl=id",
    color: "#E4405F",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@abdelkaderboukert",
    icon: Github,
    url: "https://github.com/abdelkderboukert",
    color: "#ffffff",
